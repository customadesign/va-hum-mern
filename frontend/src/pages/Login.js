          ...
          <form className="mt-8 space-y-6" onSubmit={formik.handleSubmit}>
            ...
            <>
              ...
              <div className="mt-6">
                <button
                  type="button"
                  onClick={() => window.open('https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=862opndk5vhk47&redirect_uri=http://localhost:3001/auth/linkedin/callback&state=' + Math.random().toString(36).substring(2, 15) + '&scope=r_liteprofile%20r_emailaddress', '_blank')}
                  disabled={loading}
