...
export default function Dashboard() {
  ...
  const { data: profileData } = useQuery({
    ...
    queryFn: async () => {
      // Always use /users/profile endpoint which returns both VA and Business profiles
  ...
  const profileCompletion = useMemo(() => {
    ...
    if (branding.isESystemsMode) {
      // Business profile completion logic - matching Business/Profile.js calculation
