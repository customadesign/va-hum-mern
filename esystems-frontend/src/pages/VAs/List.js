        ...
        <div className="mt-6 bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <form onSubmit={handleSearch} className="sm:flex sm:items-center">
              ...
              <button
                type="submit"
                className="btn-primary mt-3 w-full inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm font-medium rounded-md sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
              >
                Search
              </button>
              <button
          ...
          {isLoading ? (
            ...
            <>
              <div className="overflow-hidden sm:rounded-md">
                ...
                {/* List of VA cards 
                <ul className="va-cards divide-y divide-gray-200">
                  {data?.data?.map((va) => (
                    <li className='list-item-va-card my-2' key={va._id}>
                      <VACard va={va} />
                    </li>
                  ))}
                </ul>
